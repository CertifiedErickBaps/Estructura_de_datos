...
public class SortingAlgorithmsTest {
    ...
    public void testSelectionSort() {
        assertEquals(stringListEmpty, SortingAlgorithms.selectionsort(stringListEmpty));
        assertEquals(doubleListSorted, SortingAlgorithms.selectionsort(doubleList));
        assertEquals(doubleListSorted, SortingAlgorithms.selectionsort(doubleListSorted));
        assertEquals(stringListSorted, SortingAlgorithms.selectionsort(stringList));
        assertEquals(stringListSorted, SortingAlgorithms.selectionsort(stringListSorted));
        assertEquals(integerListSorted, SortingAlgorithms.selectionsort(integerList));
        assertEquals(integerListSorted, SortingAlgorithms.selectionsort(integerListSorted));
    }
    ...
    public void testBucketSort() {
        ...
        assertEquals(aSorted, SortingAlgorithms.bucketsort(a));
        assertEquals(aSorted, SortingAlgorithms.bucketsort(aSorted));
        assertEquals(integerListEmpty, SortingAlgorithms.bucketsort(integerListEmpty));
    }
    ...
    public void testBogoSort() {
        ...
        assertEquals(aSorted, SortingAlgorithms.bogosort(a));
        assertEquals(aSorted, SortingAlgorithms.bogosort(aSorted));
        assertEquals(doubleListSorted, SortingAlgorithms.bogosort(doubleList));
        assertEquals(doubleListSorted, SortingAlgorithms.bogosort(doubleListSorted));
        assertEquals(stringListEmpty, SortingAlgorithms.bogosort(stringListEmpty));
        assertEquals(doubleListEmpty, SortingAlgorithms.bogosort(doubleListEmpty));
    }

    @Test
    public void testQuickSort() {
        assertEquals(stringListEmpty, SortingAlgorithms.quicksort(stringListEmpty));
        assertEquals(doubleListSorted, SortingAlgorithms.quicksort(doubleList));
        assertEquals(doubleListSorted, SortingAlgorithms.quicksort(doubleListSorted));
        assertEquals(stringListSorted, SortingAlgorithms.quicksort(stringList));
        assertEquals(stringListSorted, SortingAlgorithms.quicksort(stringListSorted));
        assertEquals(integerListSorted, SortingAlgorithms.quicksort(integerList));
        assertEquals(integerListSorted, SortingAlgorithms.quicksort(integerListSorted));
    }
}
